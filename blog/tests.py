...
class BlogTests(TestCase):
    ...
    def test_post_updateview(self):
        ...
        post = Post.objects.create(title="To update", body="Old", author=self.user)
        response = self.client.post(
        ...
        self.assertEqual(Post.objects.get(pk=post.pk).title, "Updated title")
        self.assertEqual(Post.objects.get(pk=post.pk).body, "Updated text")

    def test_post_deleteview(self):
        # create a post to delete
        post = Post.objects.create(title="To delete", body="Delete me", author=self.user)
